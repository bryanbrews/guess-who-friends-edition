# Gillow — the German Zillow

Live at **pacbrewlab.com/gillow/** (served as a static folder of this
Cloudflare Pages project — no backend needed).

![Gillow estimating a Munich apartment](../docs/gillow-screenshot.png)
...
Gillow rebuilds an estimate from these pieces: it anchors on official
...
node scripts/gillow/fetch_official_nrw.mjs --trend
...
```bash
node dev-server.mjs
# open http://localhost:8788/gillow/
```
